...
export default function Hero() {
  return (
    <section
      aria-labelledby="prodoo-apps-heading"
      ...
      <div className="relative flex justify-center items-center mt-16 w-29.75 h-10">
        <div className="h-10 flex w-full justify-center items-center border-t border-b border-[#FFFFFF] bg-[#FFFFFF40] font-medium text-sm text-foreground">
          <span className="flex flex-wrap items-center gap-1">
            <span className="text-primary font-bold">ProDoo Apps</span>
          </span>
        </div>
      </div>
      <div className="flex flex-col gap-2 text-center items-center justify-center w-full max-w-261 mt-2">
        <h1
          id="prodoo-apps-heading"
          className="text-foreground text-[40px] font-semibold leading-13"
        >
          Apps to Hire Talent, Grow Freelancing & Manage Work
        </h1>
        <p className="font-normal text-muted-foreground text-[16px] leading-6">
          ProDoo Apps streamline freelancing, remote hiring, and project
          management. They connect freelancers, recruiters, and businesses
          globally, offering AI tools for efficient collaboration.
        </p>
      </div>
    </section>
  );
